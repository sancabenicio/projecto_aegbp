...
# Rodrigo Moyle <rodrigorm@gmail.com>, 2023
...
"Last-Translator: Rodrigo Moyle <rodrigorm@gmail.com>, 2023\n"
"Language-Team: Portuguese (Brazil) (http://app.transifex.com/Bouke/django-two-factor-auth/language/pt_BR/)\n"
"MIME-Version: 1.0\n"
...
#: forms.py:30 forms.py:51 forms.py:109 forms.py:163 plugins/email/forms.py:19
#: plugins/webauthn/forms.py:67
msgid "Token"
msgstr "Código"

#: forms.py:36 forms.py:58 plugins/webauthn/forms.py:88
#: plugins/webauthn/forms.py:133
...
msgstr "Não peça novamente neste dispositivo por %(minutes)i minutos"

#: forms.py:146
#, python-format
msgid "Don't ask again on this device for %(hours)i hours"
msgstr "Não peça novamente neste dispositivo por%(hours)i horas"

#: forms.py:149
#, python-format
msgid "Don't ask again on this device for %(days)i days"
msgstr "Não peça novamente neste dispositivo por %(days)i dias"
...
msgstr "Estamos ligando para o seu telefone agora, por favor digite os dígitos que ouvir."

#: plugins/phonenumber/method.py:45 plugins/phonenumber/utils.py:25
msgid "Phone call"
msgstr "Chamada telefônica"

#: plugins/phonenumber/method.py:50 plugins/phonenumber/utils.py:27
msgid "Text message"
msgstr "Mensagem de texto"

#: plugins/phonenumber/models.py:14
msgid "Phone Call"
msgstr "Chamada telefônica"

#: plugins/phonenumber/models.py:15
msgid "Text Message"
msgstr "Mensagem de texto"

#: plugins/phonenumber/models.py:37
msgid "method"
msgstr "mecanismo"
...
msgstr "Por favor, digite o código gerado pelo seu gerador de códigos."

#: plugins/webauthn/forms.py:102
msgid "WebAuthn Token"
msgstr "Token WebAuthn"

#: plugins/webauthn/method.py:14
msgid "WebAuthn"
msgstr "WebAuthn"

#: plugins/webauthn/method.py:62
msgid "Authenticate using a WebAuthn-compatible device"
msgstr "Autenticar usando um dispositivo compatível com WebAuthn"

#: plugins/webauthn/method.py:65
msgid "Please use your WebAuthn-compatible device to authenticate."
msgstr "Use seu dispositivo compatível com WebAuthn para autenticar."
...
#: plugins/yubikey/method.py:38
msgid "Use your Yubikey device"
msgstr "Use seu dispositivo Yubikey"

#: plugins/yubikey/method.py:41
...
msgstr "Códigos reservas podem ser usados quando seus números primários e substitutos não estão disponíveis. Os códigos reservas abaixo podem ser usados para verificações de conexão. Se você já usou todos os seus códigos reservas, você pode gerar um novo conjunto de códigos reservas. Somente os códigos reservas mostrados abaixo serão válidos."
...
msgstr "Use esse formulário para inserir os códigos reservas para se conectar. Esses códigos foram gerados para você imprimir e manter seguros. Por favor, digite um deles para se conectar à sua conta."

#: templates/two_factor/core/login.html:29
msgid "Or, alternatively, use one of your other authentication methods:"
msgstr "Ou, alternativamente, use um de seus outros métodos de autenticação:"

#: templates/two_factor/core/login.html:48
...
msgstr "A página solicitada, força os utilizadors a autenticar usando verificação em duas etapas por questões de segurança. Você precisa habilitar esses recursos de segurança a fim de acessar esta página."
...
msgstr "Verificação em duas etapas não está habilitada para a sua conta. Habilite a verificação em duas etapas para aprimorar a segurança de sua conta."
...
msgstr "Você está adicionando um telefone reserva para a sua conta. Este número será usado se o seu método primário de cadastro não estiver disponível."

#: templates/two_factor/core/phone_register.html:12
msgid ""
"We've sent a token to your phone number. Please enter the token you've "
"received."
msgstr "Nós lhe enviamos um código para o seu número de telefone. Por favor, digite o código recebido."
...
msgstr "Você está prestes a levar a segurança de sua conta para o próximo nível. Siga os passos deste assistente para habilitar a verificação em duas etapas."

#: templates/two_factor/core/setup.html:15
msgid "Please select which authentication method you would like to use."
msgstr "Por favor selecione qual dos métodos de autenticação você gostaria de usar."
...
msgstr "Para começar a usar um gerador de códigos, por favor use seu celular para escanear o código QR abaixo. Por exemplo, use o Google Authenticator."
...
msgstr "Como alternativa, você pode usar o seguinte segredo para configurar o TOTP em seu autenticador ou gerenciador de senhas manualmente."
...
msgstr "Em seguida, digite o código gerado pelo aplicativo."
...
msgstr "Por favor digite o número de telefone no qual você deseja receber as mensagens de texto. Este número será validado no próximo passo."
...
msgstr "Por favor, digite o número de telefone no qual você deseja ser chamado. Este número será validado no próximo passo."

#: templates/two_factor/core/setup.html:40
msgid "We sent you a text message, please enter the tokens we sent."
msgstr "Nós lhe enviamos uma mensagem de texto, por favor digite o código enviado."
...
msgstr "Nós encontramos um problema com o método de autenticação selecionado. Por favor, volte para verificar se você digitou suas informações corretamente, tente novamente, ou use um método de autenticação diferente ao invés. Se o problema persistir, contate o administrador do site."
...
msgstr "Para identificar e verificar sua YubiKey, por favor insira o código no campo abaixo. Sua YubiKey será ligada à sua conta."
...
msgstr "Contudo, pode ser que você não tenha acesso ao seu dispositivo de código primário. Para habilitar a recuperação de conta, adicione um número de telefone."
...
msgstr "Você está prestes a desabilitar a verificação em duas etapas. Isto enfraquecerá a segurança de sua conta, você tem certeza que quer continuar?"
...
msgstr "Se seu método primário não estiver disponível, nós podemos lhe enviar os códigos reservas para o telefone listado abaixo."
...
"backup tokens."
msgstr "Se você não tiver nenhuma dispositivo com você, você pode acessar sua conta usando os códigos reservas."
...
msgstr[0] "Você tem somente um código reserva restante."
msgstr[1] "Você têm %(counter)s códigos reservas restantes."
msgstr[2] "Você têm %(counter)s códigos reservas restantes."
...
msgstr "Apesar de nós o desencorajarmos fortemente a fazer isso, você também pode desabilitar a verificação em duas etapas de sua conta."

#: templates/two_factor/twilio/sms_message.html:2
#, python-format
msgid "Your OTP token is %(token)s"
msgstr "Seu token OTP é %(token)s"

#: views/core.py:274
msgid "Your session has timed out. Please login again."
msgstr "Sua sessão expirou. Por favor, conecte-se novamente."

#: views/utils.py:153
msgid "ManagementForm data is missing or has been tampered with"
msgstr "Dados do ManagementForm estão ausentes ou foram adulterados"
